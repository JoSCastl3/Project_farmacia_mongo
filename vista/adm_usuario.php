                ...
                <div class="modal-content">
                    <div class="card-success">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form-crear" action="../controlador/UsuarioController.php" method="post">
                                <div class="form-group">
                                    <label for="nombre">Nombres</label>
                                    <input id="nombre" name="nombre" required type="text" class="form-control" placeholder="Ingrese nombre">
                                </div>
                                <div class="form-group">
                                    <label for="apellido">Apellidos</label>
                                    <input id="apellido" name="apellido" required type="text" class="form-control" placeholder="Ingrese apellidos">
                                </div>
                                <div class="form-group">
                                    <label for="edad">Nacimiento</label>
                                    <input id="edad" name="edad" required type="date" class="form-control" placeholder="Ingrese nacimiento">
                                </div>
                                <div class="form-group">
                                    <label for="dui">DUI</label>
                                    <input id="dui" name="dui" required type="text" class="form-control" placeholder="Ingrese dui">
                                </div>
                                <div class="form-group">
                                    <label for="pass">Contraseña</label>
                                    <input id="pass" name="pass" required type="password" class="form-control" placeholder="Ingrese contraseña">
                                </div>
